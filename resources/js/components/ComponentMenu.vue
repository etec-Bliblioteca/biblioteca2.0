...
<template>
    <div class="menuBackground" v-show="active">
        <div class="containerLinks">
            ...
            <Link class="menuLink active" href="/login" id="linkUser" v-show="!user">
                <svg 
                    class="linkIcon"
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <Link class="menuLink" :href="userLink" id="linkUser" v-show="user">
            ...
            <Link class="menuLink" href="/logoff" id="linkUser" v-show="page == 4">
