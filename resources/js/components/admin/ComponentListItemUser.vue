...
<template>
    <tr class="listItem">
        ...
        <td>{{ email }}</td>
        <td>{{ telefone }}</td>
        <td v-if="nivel == 0">Aluno</td>
        <td v-else>Administrador</td>
        <td class="containerButtons">
            <button title="Editar" @click="$emit('toggleForm')">
                <!-- Ícone lápis -->
                <svg
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <button title="Excluir" @click="$emit('deleteItem')">
                <!-- Ícone lixeira -->
                <svg
                    viewBox="0 0 24 24"
                    fill="none"
...
.listItem:hover .containerButtons {
    opacity: 1;
    pointer-events: auto;
}
