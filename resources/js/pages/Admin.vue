...
import CardAgd from '@/components/admin/ComponentCardAgd.vue';
...
<template>
    <div class="containerAdmin">
        <Menu page="0"></Menu>
        <div class="painel">
            <Title text="Dados atuais"></Title>
            <div class="content">
                <div class="card" id="cardRevistas">
                    <div class="cardDataContainer">
                        <p class="cardData">{{ DataInfo.revistas }}</p>
                        <h1 class="cardTitle">revistas</h1>
                    </div>
                ...
                <div class="card" id="cardUsers">
                    <div class="cardDataContainer">
                        <p class="cardData">{{ DataInfo.users}}</p>
                        <h1 class="cardTitle">usuarios</h1>
                    </div>
            ...
            <Title text="agendamentos atuais"></Title>
            <div class="content" v-if="AgdAtuais.length > 0">
                <CardAgd v-for="agd in AgdAtuais" :key="agd.id" :id="agd.id" :NomeAluno="agd.name" :Revista="agd.titulo" :RM="agd.rm" :Turma="agd.turma" :Dt_Devolver="agd.dt_devolver" :Imagem="agd.imagem" :telefone="agd.telefone"/>
            </div>
            <div class="content" v-else>
                <Subtitulo nomeSubtitulo="Sem agendamentos Vencidos"/>
            </div>
            
            <Title text="agendamentos vencidos"></Title>
            <div class="content" v-if="AgdVencidos.length > 0">
                <CardAgd v-for="agd in AgdVencidos" :key="agd.id"  :id="agd.id" :NomeAluno="agd.name" :Revista="agd.titulo" :RM="agd.rm" :Turma="agd.turma" :Dt_Devolver="agd.dt_devolver" :Imagem="agd.imagem" :telefone="agd.telefone"/>
            </div>
            <div class="content" v-else>
                <Subtitulo nomeSubtitulo="Sem agendamentos Vencidos"/>
            </div>
...
<style>
    ...
    #cardRevistas .cardTitle{
        color: #B7192C;
    }

    #cardRevistas svg path{
        fill: #B7192C;;
    }
