...
export default {
    ...
    mounted() {
        window.Echo.channel(`newAgend`).listen(".addNewAgend", (e) => {
            console.log(e);
            this.Agendamentos.push(e.newAgend);
            if (Notification.permission === "granted") {
                new Notification("Novo agendamento", {
                    body: "Acesse a página de pedidos para realizar a confirmação",
                });
            }
        });
    },
    ...
    <div class="containerAdmin">
        ...
        <div class="painel">
            ...
            <div class="containerCards">
                <CardPedido
                    v-for="dataAgend in Agendamentos"
                    :key="dataAgend.id"
                    :idAgend="dataAgend.id"
                    :nomeAluno="dataAgend.name"
                    :dtPegar="dataAgend.dt_pegar"
                    :nomeRevista="dataAgend.titulo"
                    :rm="dataAgend.rm"
