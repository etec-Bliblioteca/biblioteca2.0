<script>
import FormUser from "@/components/admin/ComponentFormUser.vue";
import ListItemUser from "@/components/admin/ComponentListItemUser.vue";
        ...
        deleteItem(idUser, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.submit("delete", "/admin/users", {
                        onSuccess: () => {
                            const flash = usePage();
                            Swal.fire({
